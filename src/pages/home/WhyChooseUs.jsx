...
const WhyChooseUs = () => {
    ...
    return (
        <section className="bg-[linear-gradient(rgba(255,255,255,0.8),rgba(255,255,255,0.8)),url('/images/bg-image-2.jpg')] bg-cover bg-center flex justify-between items-start w-full px-4 py-5 gap-6 flex-wrap lg:flex-nowrap">
            <div className="flex flex-col justify-start items-start w-full lg:w-[55%]">
                <h2 className="text-[20px] uppercase font-semibold text-gray-800">Mindfully Made Packaging</h2>
                <p className="text-[35px] font-semibold leading-tight text-gray-800">
                    Our Anthem is ‘We’ll Lead with Innovative Excellence.’
                </p>
                <div className="w-full grid grid-cols-2 my-3 gap-x-5 gap-y-3">
                    <Card icon={<BiSupport size={20} className="text-gray-800" />} title="24*7 Support" description="Train with the best experts in body building field." />
                    ...
                    <Card icon={<MdOutlineDesignServices size={20} className="text-gray-800" />} title="Quick Service" description="Our personal trainers will help you find a perfect workout." />
                    <Card icon={<DiModernizr size={20} className="text-gray-800" />} title="Modernisation" description="Upgrade your critical parts of your elevators." />
                </div>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo, enim eaque esse, delectus corrupti expedita officiis sunt blanditiis dicta quidem molestias neque earum distinctio placeat tenetur, labore incidunt voluptatibus veritatis eum repudiandae! Expedita repudiandae similique, veniam rerum accusantium blanditiis quibusdam excepturi iste ullam, quo, vitae natus? Nostrum ipsum voluptates laborum unde pariatur possimus molestias animi sunt delectus, veniam distinctio repellat doloremque cupiditate a voluptatibus in ipsa modi quasi ipsam. Atque illo voluptas officia quos iure nisi minus at explicabo voluptatibus corrupti molestiae aliquam, quas suscipit minima iste enim id, voluptatem, cum nemo sint quis veritatis quia! Beatae aliquid inventore rem!</p>
            </div>
